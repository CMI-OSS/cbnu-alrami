import { BadRequestException, ConflictException, NotAcceptableException, NotFoundException, UnauthorizedException } from "@nestjs/common";
...
export const errors = {
  ...
  LOGIN_INFO_NOT_FOUND: new NotFoundException('일치하는 로그인 정보가 없습니다.'),
  TOKEN_REQUIRED: new UnauthorizedException('토큰이 필요합니다.', '토큰이 필요합니다.'),
  LOGIN_REQUIRED: new UnauthorizedException('로그인이 필요합니다.', '로그인이 필요합니다.'),
  TOKEN_EXPIRED: new UnauthorizedException('토큰이 만료되었습니다.', '토큰이 만료되었습니다.'),
